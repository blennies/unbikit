 ...
 *
 * Table contains a sub-table for intra-frame followed by a sub-table for inter-frame values. Each
 * sub-table consists of 16 levels, each containing 64 values for an 8x8 DCT block. Each level is
 * generated by scaling a base quantization matrix by a predetermined factor.
 *
